...
If you want your handout be organized with the same sectioning commands as in your main paper, you can use the option \opt{sectioning} when loading the package. See example~4.

\section{Numbering the examples}

The package option \opt{numbering} automatically number the example. The example's number is by default printed in margin, in a frame. See example~5. 
